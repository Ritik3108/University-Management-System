...
public class UpdateStudent extends JFrame implements ActionListener{
	...
	UpdateStudent()
	{
		...
		l15=new JLabel("Select Roll no. to Update the Data of Student :-");
	...
	setVisible(true);}
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			try
			{
				...
				String q="update student set name='"+a+"',fathers_name='"+g+"',age='"+b+"', dob='"+h+"',address='"+c+"',phone='"+i+"',email='"
						+ ""+d+"',class_x='"+j+"',class_xii='"+E+"',aadhar='"+k+"',rollno='"+f+"',course='"+m+"',branch='"+l+"' where rollno='"+ch.getSelectedItem()+"'";
			...
			else if(e.getSource()==b3)
			{
				try
				{
					String str="select * from student where rollno = '"+ch.getSelectedItem()+"'";
